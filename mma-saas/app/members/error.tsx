      ...
      <main className="max-w-7xl mx-auto px-8 py-16">
        ...
        >
          <h1 className="text-2xl mb-3" style={{ color: "#FFFFFF", fontWeight: 500 }}>
            Something went wrong loading your members
          </h1>
          <p className="mb-6" style={{ color: "#888888" }}>
            Your roster is safe — this is a display problem, not a data problem.
            Try again, and if it keeps happening the reference below will help us
            track it down.
          </p>
